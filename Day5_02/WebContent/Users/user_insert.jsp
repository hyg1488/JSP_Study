...
//		if(document.getElementByIdNames("name")[0].value == ""){	배열일경우
//			alter("A");
//		}

		users.action ="user_insert.do";
		users.submit();
									...
									<tr>
										<td bgcolor="#7AAAD5">
											...
											<table cellpadding=3 cellspacing=1 border=0 width=100%>
													...
													<TD BGCOLOR=WHITE>
														<table cellspacing=0 cellpadding=0>
															<tr>
																...
																<td><img src="Users/img/u_bt01.gif" hspace=2 border=0
												...
												<tr>
													...
													<td bgcolor=WHITE valign=middle><input type="text"
														...
														name="email2" maxlength="15"> <select
														name="email3">
											...
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												...
												<tr bgcolor=#ffffff>
													<td colspan=3 align=center><img src="Users/img/u_bt06.gif"
														vspace=3 border=0 name=img3 onclick="send()"> 
														<a href="javascript:out();"><img
														src="Users/img/u_bt05.gif" border=0 hspace=10 vspace=3
														name=img4></a></td>
												</tr>
											</table>
										</td>
