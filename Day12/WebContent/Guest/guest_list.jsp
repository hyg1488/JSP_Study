...
<%@page import = "java.sql.*, Day12.model.*, java.util.*"%>
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" width="100%" align="center">
      ...
      <tr>
		...
		<%
			if(count == 0){	// if(list.size( == 0)) 도 가능
		%>
		...
		<%
						...
						List<BoardVO> list = dao.guestList();
        ...
        <font face="돋움" size="2" color="#000000"><a class="list" href="guest_view.jsp?idx=<%=list.get(i).getIdx() %>">
