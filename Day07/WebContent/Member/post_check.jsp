...
<script>
	function close_ss(zipcode, addr) {
		
		opener.document.mem.zip.value = zipcode;
		opener.document.mem.addr1.value = addr;
		self.close();
	}
</script>
</HEAD>
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330><TR><TD BGCOLOR=#948DCF>
  <TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=330><TR><TD>
    ...
    <FORM NAME="inquiry" METHOD="post" ACTION="post_check.jsp" onSubmit="return check();">
      ...
      <TR>
        <TD><a href="javascript:close_ss('123','대전광역시 중구 도마동 123')">123-123 대전광역시 중구 도마동 123</a>
        </TD>
      </TR>
      <TR>
        <TD><a href="javascript:close_ss('122')">122-123 대전광역시 중구 도마동 123</a>
        </TD>
      </TR>
      <TR>
        <TD><a href="javascript:close_ss('121')">121-123 대전광역시 서구 도마동 123</a>
        </TD>
      </TR>
...
<TABLE CELLPADDING=0 CELLSPACING=0 BORDER=0 WIDTH=330>
  ...
  <tr>
    <td colspan=2 align=center>
      <img src="./img/u_bt13.gif" border=0 vspace=5 onclick="close()">    </td>
  </tr>
</table>
</BODY>
</HTML>
