...
<script>
	function id_check(){
		...
		window.open(url, "id_check", "width=350 height=300");
		mem.submit();
	}
	
	function post_check(){
		window.open("post_check.jsp", "post_check", "width=350 height=350");
	}
			...
			<table cellpadding=0 cellspacing=0 border=0 width=650 align=center>       
				<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											...
											<td>
                  			<a href="javascript:id_check()"><img src="./img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
                 ...
                 6~12자 이내의 영문이나 숫자만 가능합니다.
                  		...
                  		<td>
      									<img src="./img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle onclick="post_check()">
 											</td>
										</tr>
									</table>
								</td>
